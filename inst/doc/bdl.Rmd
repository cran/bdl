...
This function will download and load maps automatically. In case of any errors you can download them manually [here](https://github.com/statisticspoland/R_Package_to_API_BDL/releases/tag/1.0.1).
